...
Freshness rules follow the cron syntax. If you're new to cron, you can use tools like crontab.guru to help you define the period syntax more easily.
...
You can also set the value of a variable for a customer group by specifying the group's tag.
